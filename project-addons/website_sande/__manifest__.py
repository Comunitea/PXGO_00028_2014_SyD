...

{
    ...
    'data': [
        ...
        'templates/business_divisions.xml',
        'templates/pumping_systems.xml',
        'templates/centrifugal_pumps.xml',
        'templates/industrial_machinery.xml',
        'templates/water_treatment.xml',
        'templates/sewage_purification.xml',
